SELECT
	...
	COUNT(DISTINCT orders.order_id)/COUNT(DISTINCT website_sessions.website_session_id) AS session_to_order_conversiob_rate
...
-- Assigment 2 Comparing Channel Characteristics
...
SELECT 
    CASE 
        ...
        WHEN http_referer =  'https://www.bsearch.com' THEN  'bsearch_orgainc'
        ELSE 'other'
	END AS cases,
...
SELECT 
    CASE 
        ...
        WHEN http_referer =  'https://www.bsearch.com' AND utm_source IS NULL THEN 'bsearch_orgainc'
        ELSE 'other'
	END AS cases,
    COUNT(DISTINCT website_session_id) AS sessions
FROM website_sessions
...
SELECT DISTINCT
	CASE
		WHEN utm_source IS NULL AND http_referer('https://www.gsearch.com','https://www.bsearch.com') THEN 'organic_search'
        WHEN utm_campaign = 'nobrand' THEN 'paid_search'
        WHEN utm_source IS NULL AND http_referer IS NULL THEN 'direct_type_in'
	END AS channel_group,
	utm_source,
    utm_campaign,order_item_refunds
    http_referer
FROM website_sessions
